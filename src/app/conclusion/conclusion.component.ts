...
import { CommonModule } from '@angular/common';
import { RevealOnScrollDirective } from '../directives/reveal-on-scroll.directive'; // 1. Importe a diretiva

@Component({
  selector: 'app-conclusion',
  standalone: true,
  imports: [CommonModule, RevealOnScrollDirective], // 2. Adicione a diretiva
  templateUrl: './conclusion.component.html',
  styleUrl: './conclusion.component.css'
})
export class ConclusionComponent {
  // O componente permanece limpo e focado na apresentação
}
